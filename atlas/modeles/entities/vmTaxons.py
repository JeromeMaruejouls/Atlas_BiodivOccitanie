...
class VmTaxons(Base):
    __table__ = Table(
        ...
        Column("badge_lrm", String(255)),
        Column("badge_lrm_citation", String(255)),
        Column("badge_lrm_url", String(255)),
        Column("badge_lre", String(255)),
        Column("badge_lre_citation", String(255)),
        Column("badge_lre_url", String(255)),
        Column("badge_lrn", String(255)),
        Column("badge_lrn_citation", String(255)),
        Column("badge_lrn_url", String(255)),
        Column("badge_lrr", String(255)),
        Column("badge_lrr_citation", String(255)),
        Column("badge_lrr_url", String(255)),
        Column("badge_zdet", String(20)),
        Column("badge_zdet_citation", String(255)),
        Column("badge_zdet_url", String(255)),
        Column("badge_eee", String(20)),
        Column("badge_eee_citation", String(255)),
        Column("badge_eee_url", String(255)),
